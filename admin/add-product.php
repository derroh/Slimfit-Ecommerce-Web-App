							                ...
							                //  $imagedata = file_get_contents($_FILES["animal_images"]["tmp_name"]);
							                  ...
							                  $imgSize = $_FILES['ProductPhoto']['size'];
							            			...
							            			if(in_array($imgExt, $valid_extensions)){
							    					 ...
							    					 if(!isset($errMSG))
							    					 {
							    							$stmt = $db->prepare('INSERT INTO shop_items(Category, Brand, Name, Image, Colour, Description, Price, Quantity, SetAsNew, FeaturedItem) VALUES (:Category, :Brand, :Name, :Image, :Colour, :Description, :Price, :Quantity, :SetAsNew, :FeaturedItem)');
													 ...
													 <form class="form-horizontal" id="my-form" method="post" action="" enctype="multipart/form-data">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="ProductName" id="ProductName" class="col-xs-12 col-sm-6" value="<?php if(isset($_POST)){echo $_POST['ProductName'];} ?>" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="Colour" id="Colour" class="col-xs-12 col-sm-6" value="<?php if(isset($_POST)){echo $_POST['Colour'];} ?>" />
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<textarea id="Description" class="autosize-transition form-control" name="Description"><?php if(isset($_POST)){echo htmlspecialchars($_POST['Description']);}  ?></textarea>
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="Price" id="Price" class="col-xs-12 col-sm-6" value="<?php if(isset($_POST)){echo $_POST['Price'];} ?>" />
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" class="input-sm" id="Quantity" name="Quantity" />
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div>
																		<label class="line-height-1 blue">
																			<input name="NewItem" value="1" type="radio" class="ace" />
																	...
																	<div>
																		<label class="line-height-1 blue">
																			<input name="NewItem" value="2" type="radio" class="ace" />
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div>
																		<label class="line-height-1 blue">
																			<input name="featured" value="1" type="radio" class="ace" />
																			<span class="lbl"> Yes</span>
																		</label>
																	</div>
																	...
																	<div>
																		<label class="line-height-1 blue">
																			<input name="featured" value="2" type="radio" class="ace" />
																			<span class="lbl"> No</span>
																		</label>
																	</div>
																</div>
