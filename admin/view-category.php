								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div>
											...
											<?php $brands = $user->display_categories(); ?>
												<tbody>
												<?php foreach ($brands as $item) :?>
													<tr>
														...
														<td>
															...
															<a class="green" href="edit-category.php?id=<?php echo $item['Id']; ?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red delete_cat" data-id="<?php echo $item['Id']; ?>" href="javascipt:void(0)">
