<?php
	$pagetitle ="Unconfirmed Orders";
	$activeOrdersParent= "active open";
	$activeUnConfirmed = "active";
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Unconfirmed Orders</li>
						</ul><!-- /.breadcrumb -->
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-header">
											All available Unconfirmed Orders
										</div>
										...
										<div>
											...
											<?php $query = "select DISTINCT `customer_orders`.`CartId`,
