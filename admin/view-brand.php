								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div>
											...
											<?php $brands = $user->display_brands(); ?>
												<tbody>
												<?php foreach ($brands as $item) :?>
													<tr>
														...
														<td>
															...
															<a class="green" href="edit-brand.php?id=<?php echo $item['Id']; ?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red delete_brand" data-id="<?php echo $item['Id']; ?>" href="javascipt:void(0)">
				...
				bootbox.dialog({
					...
					danger: {
						...
						callback: function() {
							...
							$.post('../custom/deletebrand.php', { 'delete':pid })
