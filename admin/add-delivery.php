				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Add delivery points</li>
						</ul><!-- /.breadcrumb -->
											...
											<div id="fuelux-wizard-container">
												...
												<div class="step-content pos-rel">
													<div class="step-pane active" data-step="1">
														...
														<form class="form-horizontal" id="categories-form" method="get">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="DeliveryPointName" id="DeliveryPointName" class="col-xs-12 col-sm-6" />
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="Amount" id="Amount" class="col-xs-12 col-sm-6" />
																	</div>
																</div>
															</div>
			...
			jQuery(function($) {
				...
				.on('actionclicked.fu.wizard' , function(e, info){
					if(info.step == 1 && $validation) {
						if(!$('#categories-form').valid()) e.preventDefault();
					}
				})
				//.on('changed.fu.wizard', function() {
				//})
				.on('finished.fu.wizard', function(e) {
					$.post('../custom/adddelivery.php',
				  {
				     DeliveryPointName: $('[name=DeliveryPointName]').val(), Amount: $('[name=Amount]').val()
				  },
					function(data){
					 bootbox.dialog({
						 message: data,
