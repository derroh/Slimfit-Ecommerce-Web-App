													...
													<div class="step-pane active" data-step="1">
														...
														<form class="form-horizontal" id="brands-form" method="get">
															...
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="BrandName">Brand Name:</label>

																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="BrandName" id="BrandName" class="col-xs-12 col-sm-6" value="<?php echo $user->getBrand($_GET['id']);?>" />
																	</div>
																</div>
															</div>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.on('finished.fu.wizard', function(e) {
					$.post('../custom/updatebrand.php',
				  {
				     BrandName: $('[name=BrandName]').val(), Id: '<?php echo $_GET['id']?>'
				  },
					function(data){
					 bootbox.dialog({
						 message: data,
				...
				$('#brands-form').validate({
				    ...
				    BrandName: "Please enter the brand's name"
					},
