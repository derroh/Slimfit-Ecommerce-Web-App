			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<?php include('../includes/back/nav-setings.php');?>
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-header">
											Showing available items on order <?php echo $_GET['id']; ?>
										</div>
                      ...
                      $cart = $_GET['id'];
											$products_query = "select `customer_orders`.`Id`,
                           `customer_orders`.`Name`,
                           `customer_orders`.`Image`,
                    ...
                    ";
                            ...
                            <td><img alt="product 1" tyle="width: 70px; height: 80px" src="../<?php echo $item['Image'];?>"></td>
														<td><?php echo $item['Price'] ?></td>
														<td><?php echo $item['Quantity']?></td>
														<td><?php echo $item['Total']; ?></td>
                            <td><?php echo  date('jS M Y', strtotime($item['DatePlaced'])) ;?></td>
